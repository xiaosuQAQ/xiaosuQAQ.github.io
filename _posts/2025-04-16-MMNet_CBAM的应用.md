...
在介绍[CBAM（Convolutional Block Attention Module）](/2025-04-12-SENet和CBAM.md)之后，我们来看一下这个模块在多模态任务中的一个应用：《[MM-UNet: A multimodality brain tumor segmentation network in MRI images》](https://www.frontiersin.org/journals/oncology/articles/10.3389/fonc.2022.950706/full)（2区），面向脑部肿瘤分割的多模态网络——MMNet。
